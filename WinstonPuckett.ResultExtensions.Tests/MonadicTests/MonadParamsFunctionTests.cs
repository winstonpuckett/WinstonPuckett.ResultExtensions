...
namespace WinstonPuckett.ResultExtensions.Tests.MonadicTests
{
    public class MonadParamsFunctionTests
    {
        ...
        private async Task<bool> FlipAsync(bool b) => await Task.Run(() => !b);
        private bool ThrowNotImplementedException(bool _) { throw new NotImplementedException(); }
        private async Task<bool> ThrowNotImplementedExceptionAsync(bool _) { await Task.Run(() => throw new NotImplementedException()); return false; }
