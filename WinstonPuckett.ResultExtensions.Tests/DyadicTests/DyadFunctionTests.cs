...
{
    public class DyadFunctionTests
    {
        // General data.
        ...
        public void OkTransformsToU()
        {
            ...
            Assert.Equal(!((Ok<(bool, bool)>)_okFalse).Value.Item1, ((Ok<bool>)r).Value);
        }
        ...
        public async Task OkTaskTransformsToU()
        {
            ...
            Assert.Equal(!((Ok<(bool, bool)>)await _taskOkFalse).Value.Item1, ((Ok<bool>)r).Value);
        }
